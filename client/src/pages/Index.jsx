    ...
    <>
      ...
      <section>
        <div className="row mb-5 landingpage_sec2">
          <div className="col" data-aos="fade-up" data-aos-delay="">
            <p className="main_subtitle">
              <Icon icon="foundation:checkbox" color="#232323" /> Stay
        ...
        <div className="row mb-5 mt-5 landingpage_sec2">
          <div className="col" data-aos="fade-up" data-aos-delay="">
            <p className="main_subtitle">
              <Icon icon="foundation:checkbox" color="#232323" /> Smart
              Reminders
            </p>
            <p className="main_content">
              You can create, edit, and organize tasks seamlessly from any
        ...
        <div className="row mb-5 mt-5 landingpage_sec2">
          <div className="col" data-aos="fade-up" data-aos-delay="">
            <p className="main_subtitle">
              <Icon icon="foundation:checkbox" color="#232323" /> Prioritize
              your Tasks
            </p>
            <p className="main_content">
              Effortlessly prioritize tasks by urgency and importance using our
              intuitive drag-and-drop interface. Rearrange tasks instantly and
        ...
        <div className="row mb-5 pt-5 text-center explore-more">
          <Stack>
            ...
            <div className="explore-text">
              <p>
                Unlock more possibilities! Dive into our features now. Click
                here to explore: <a href="/features">Explore Features</a>.
              </p>
            </div>
            <div>
